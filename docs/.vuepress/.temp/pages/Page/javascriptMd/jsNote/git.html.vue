<template><div><h1 id="常用-git-命令清单" tabindex="-1"><a class="header-anchor" href="#常用-git-命令清单" aria-hidden="true">#</a> 常用 Git 命令清单</h1>
<p>作者： <a href="https://www.ruanyifeng.com/" target="_blank" rel="noopener noreferrer">阮一峰<ExternalLinkIcon/></a></p>
<p>日期： <a href="https://www.ruanyifeng.com/blog/2015/12/" target="_blank" rel="noopener noreferrer">2015年12月 9日<ExternalLinkIcon/></a></p>
...
<h2 id="一、新建代码库" tabindex="-1"><a class="header-anchor" href="#一、新建代码库" aria-hidden="true">#</a> 一、新建代码库</h2>
<blockquote>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 在当前目录新建一个Git代码库</span>
...
<h2 id="二、配置" tabindex="-1"><a class="header-anchor" href="#二、配置" aria-hidden="true">#</a> 二、配置</h2>
<p>Git的设置文件为<code v-pre>.gitconfig</code>，它可以在用户主目录下（全局配置），也可以在项目目录下（项目配置）。</p>
<blockquote>
...
<h2 id="三、增加-删除文件" tabindex="-1"><a class="header-anchor" href="#三、增加-删除文件" aria-hidden="true">#</a> 三、增加/删除文件</h2>
<blockquote>
...
<h2 id="四、代码提交" tabindex="-1"><a class="header-anchor" href="#四、代码提交" aria-hidden="true">#</a> 四、代码提交</h2>
<blockquote>
...
<h2 id="五、分支" tabindex="-1"><a class="header-anchor" href="#五、分支" aria-hidden="true">#</a> 五、分支</h2>
<blockquote>
...
<h2 id="六、标签" tabindex="-1"><a class="header-anchor" href="#六、标签" aria-hidden="true">#</a> 六、标签</h2>
<blockquote>
...
<h2 id="七、查看信息" tabindex="-1"><a class="header-anchor" href="#七、查看信息" aria-hidden="true">#</a> 七、查看信息</h2>
<blockquote>
...
<h2 id="八、远程同步" tabindex="-1"><a class="header-anchor" href="#八、远程同步" aria-hidden="true">#</a> 八、远程同步</h2>
<blockquote>
...
<h2 id="九、撤销" tabindex="-1"><a class="header-anchor" href="#九、撤销" aria-hidden="true">#</a> 九、撤销</h2>
<blockquote>
...
<h2 id="十、其他" tabindex="-1"><a class="header-anchor" href="#十、其他" aria-hidden="true">#</a> 十、其他</h2>
<blockquote>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code># 生成一个可供发布的压缩包
$ git archive
